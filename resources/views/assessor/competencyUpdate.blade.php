                    ...
                    <form action="/competency-standard/update/{{ $id }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input id="basic-icon-default-message" class="form-control" placeholder="*Skill pasport" name="unit_title" type="text"
                                    aria-label="*Skill pasport" aria-describedby="basic-icon-default-message2" value="{{ $competency->unit_title }}">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="defaultSelect" class="form-select" name="major_id">
                                ...
                                @foreach ($majors as $item)
                                    <option value="{{ $item->id }}" {{ $competency->major->major_name == $item->major_name ? 'selected' : '' }}>{{ $item->major_name }}</option>
                                @endforeach
                            </select>
                        </div>
